...
// 添加分类
export const reqAddCategoty = (categoryName, parentId) =>
  ajax(BASE + "/manage/category/add", { categoryName, parentId }, "POST");
// 更新分类
export const reqUpdateCategoty = ({ categoryName, categoryId }) =>
...
export const reqProduct = (pageNum, pageSize) =>
  ajax(BASE + "/manage/products/list", { pageNum, pageSize });
// 搜索商品
export const reqSearchProducts = (pageNum, pageSize, searchType, value) =>
  ajax(BASE + "/manage/products/search", {
    pageNum,
    pageSize,
    [searchType]: value,
  });
...
export const reqUpdateProductStatus = (productId, status) =>
  ajax(BASE + "/manage/products/updateStatus", { productId, status }, "POST");
// 上传图片?

// 删除图片
export const reqDeletePicture = (name) =>
  ajax(BASE + "/manage/imgs/delete", { name }, "POST");
// 添加/更新商品
export const reqAddProduct = (
  ...
  ajax(
    "/manage/product/addUpdate",
    { isUpdate, _id, name, sc, price, categoryId, pcategoryId, imgs, detail },
    "POST"
  );
...
export const reqDeleteUser = (userId) =>
  ajax("/manage/users/delete", { userId }, "POST");
// 添加/更新用户
export const reqAddUpdateUser = (isUpdate, user = {}) =>
  ajax("/manage/users/addupdate", { isUpdate, user }, "POST");
